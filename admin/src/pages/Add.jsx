    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <input onChange={(e) => setPrice(e.target.value)} className='w-full px-3 py-2 sm:w-[120px]' value={price} type='Number' placeholder='250' />
        </div>
      </div>
      <div>
      ...
      <button className='cursor-pointer w-28 py-3 mt-4 bg-black text-white' type='submit'>
        ADD
      </button>
    </form>
  );
